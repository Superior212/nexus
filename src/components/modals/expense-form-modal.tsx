  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="flex items-center gap-2 bg-brand-primary text-brand-dark hover:bg-brand-primary/90">
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Submit a new expense for approval. Fill in all required fields.
          </DialogDescription>
        </DialogHeader>
